...
class Gui:
    ...
    def clickingWindows(self):
        ...
        r3 = ttk.Radiobutton(frm2, text='Keyboard Touch', variable=clickMode, value=3,
        ...
        ttk.Label(frm2, text="Keyboard Input").grid(row=5, column=1)
        keyboardEntry = ttk.Entry(frm2)
        keyboardEntry.grid(row=5, column=2)
        keyboardEntry.config(state="disabled")
        ...
        ttk.Button(frm2, text="done", command=clickingWindow.destroy).grid(column=2, row=6)
